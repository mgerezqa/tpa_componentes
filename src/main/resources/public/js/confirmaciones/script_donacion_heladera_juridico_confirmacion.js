document.addEventListener('DOMContentLoaded', () => {
    const confirmarCanje = document.getElementById('confirmarDonacionModal');
    const formCanje = document.getElementById('donationForm');
...
function mostrarModalConfirmacion() {
    const confirmarCanjeModal = new bootstrap.Modal(document.getElementById('confirmarDonacionModal'));
