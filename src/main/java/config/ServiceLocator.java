    ...
    public static <T> T instanceOf(Class<T> componentClass) {
        ...
        if (!instances.containsKey(componentName)) {
            if (componentName.equals(EntityManager.class.getName())) {
                ...
                ControladorColaboradorFisico instance = new ControladorColaboradorFisico(
                ...
                ControladorColaboradorJuridico instance = new ControladorColaboradorJuridico(
                        ...
                        instanceOf(RepositorioUsuarios.class),
                        instanceOf(RepositorioRoles.class),
                        instanceOf(RepositorioModeloHeladeras.class),
                        instanceOf(RepositorioProvincias.class),
                        instanceOf(RepositorioLocalidades.class),
                        instanceOf(RepositorioBarrios.class),
                        instanceOf(Repositorio.class),
                        instanceOf(CalculadoraPuntos.class));
                instances.put(componentName, instance);
                ...
                ControladorSuscripciones instance = new ControladorSuscripciones(
                        instanceOf(RepositorioSuscripciones.class),
                        instanceOf(RepositorioColaboradores.class),
                        instanceOf(RepositorioHeladeras.class));
                instances.put(componentName, instance);
                ...
                ControladorTarjetas instance = new ControladorTarjetas(
                        instanceOf(RepositorioTarjetas.class),
                        instanceOf(RepositorioVulnerables.class),
                        instanceOf(RepositorioColaboradores.class));
                instances.put(componentName, instance);
                ...
                ClientCredentials credentials = new ClientCredentials(config.getProperty("broker.clientID"),
                        config.getProperty("broker.clientUsername"),
                        config.getProperty("broker.clientPassword"));
